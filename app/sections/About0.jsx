        ...
        <div className=" container mx-auto px-4 py-20 " id='about'>
            ...
            <div className="py-4">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    <div>
                        <h2 className="text-2xl font-light text-gray-300 mb-8">Education</h2>
                        <div className="space-y-6">
                            ...
                            <div className="shadowx-hover border border-[#393A3D] p-6 rounded-lg">
                                ...
                                <p className="text-gray-500 text-sm">Self-Learning from Online Resources</p>
                            </div>
                        </div>
                    </div>

                    <div>
                        <h2 className="text-2xl font-light text-gray-300 mb-8">Skills</h2>
                        <div className="space-y-6">
                            <div className="shadowx-hover border border-[#393A3D] p-6 rounded-lg">
