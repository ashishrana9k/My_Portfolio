    ...
    return (
        <>
            <div className="container">
                <div className='xl:pb-28 px-4 mt-8'>
                    ...
                    <div className='grid xl:grid-cols-2 gap-6'>
                        <div className="rounded border border-[#393A3D]  shadowx-hover rounded-xl">
                            <div className="space-y-6 rounded-xl  grayscale hover:grayscale-0 transition-all duration-300">
                                <video
                                    autoPlay
                                    muted
                                    loop
                        ...
                        <div className="rounded border border-[#393A3D] rounded-xl">
                            <div className="space-y-6 shadowx-hover rounded-xl">
                                ...
                                <div className='px-3 py-6 space-y-6'>
                                    ...
                                    <p className='text text-base leading-relaxed'>This project is built with Next.js, Tailwind CSS, and TypeScript, focused on desktop view only. It uses @mui/material for consistent UI components and clean design. Tailwind makes styling efficient, while TypeScript adds type safety.</p>
                                </div>
                            </div>
                        </div>
